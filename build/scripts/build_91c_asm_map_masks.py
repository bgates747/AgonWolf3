...
def asm_make_map_masks(db_path, floor_nums, maps_tgt_dir):
    ...
    for floor_num in floor_nums:
        for room_id in range(10):
            ...
            # Prepare filenames
            asm_filename = f'{maps_tgt_dir}/map_{floor_num:02d}_{room_id}.inc'
...
def update_maps_asm(db_path):
    asm_file_path = os.path.join('src', 'asm', 'maps.inc')
    ...
    if auto_generated_section_start is None:
        raise ValueError("Could not find the autogenerated section in maps.inc")
